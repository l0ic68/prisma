 ...
 * @ORM\Entity(repositoryClass="Main\MainBundle\Repository\EquipeRepository")
 */
class Equipe
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="description_accueil", type="text")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="description_detail", type="text")
     */
    ...
    /**
     * Set descriptionAccueil
     *
     * @param string $descriptionAccueil
     *
     * @return Equipe
     */
